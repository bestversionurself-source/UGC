...
<body>
  <main>
    ...
    <section class="pricing" id="pricing">
      <div class="section-heading"><span>03 / SIMPLE PRICING</span><h2>Choose your package.<br><em>Place your order securely.</em></h2></div>
      <div class="price-grid"><article><span>TRY THE STUDIO</span><h3>₹0<small>/ free</small></h3><p>Create your first UGC concepts before ordering production.</p><ul><li>3 scripts per month</li><li>4 proven creative angles</li><li>Copy-ready output</li></ul><button class="button outline auth-open" type="button">Create free account</button></article><article class="featured"><span>MOST POPULAR</span><h3>₹999<small>/ one-time</small></h3><p>Order one polished UGC ad for your product or campaign.</p><ul><li>1 UGC video up to 30 seconds</li><li>Conversion-focused script</li><li>Captions included</li><li>1 revision</li></ul><button class="button light buy-plan" data-plan="creator" type="button">Order Starter</button></article><article><span>PERFORMANCE</span><h3>₹4,499<small>/ one-time</small></h3><p>Order a complete creative batch for consistent ad testing.</p><ul><li>6 UGC videos</li><li>Multiple hooks and scripts</li><li>Captions included</li><li>3 revisions + priority delivery</li></ul><button class="button outline buy-plan" data-plan="studio" type="button">Order Performance</button></article></div>
    </section>
  </main>
